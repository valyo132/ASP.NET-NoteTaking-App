...
namespace NoteTaking.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(ApplicationRole.Role_Admin).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(ApplicationRole.Role_Admin)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(ApplicationRole.Role_Client)).GetAwaiter().GetResult();
            }
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile? file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    string imagePath = Path.Combine(wwwRootPath, @"images/profile picture");
                    ...
                    user.ProfileImageURL = @"images/profile picture/" + fileName;
                }
